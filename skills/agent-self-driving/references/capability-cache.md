...
```text
docs/agent-self-driving/capabilities/selected-participants.md
```
...
```text
docs/agent-self-driving/capabilities/snapshots/<YYYY-MM-DD>-<slug>.md
```
...
```text
docs/agent-self-driving/capabilities/agent-model-profile.md
```
